            ...
            <div class="row">
                <div class="col m2 s12 offset-m10">
                    <!-- <img src="static/images/logo.jpeg" width="300px">
                     --><br><br>
                    <a class="waves-effect waves-light modal-trigger 1 brown darken-1" id="btn" href="#modal1"><p id="btn-txt">Login</p></a>
                    <a class="waves-effect waves-light modal-trigger 1 brown darken-1" id="btn" href="#modal2"><p id="btn-txt">Sign Up</p></a>
                    <!-- Modal Structure -->
                                    ...
                                    <form class="col s12" action="/gdgmcq/LoginController.html" method="post">
                                        <div class="row">
                                            <div class="input-field col s12">
                                              ...
                                              <label for="icon_prefix">phone/email</label>
                                            </div>
                                            <div class="input-field col s12">
                                        ...
                                        <input type="submit" value="SUBMIT" class="btn waves-effect waves-light 1 brown darken-1" style="margin-left: 40%;">
                                    </form>
                                </div>
                            </div>
                        </div>
            	...
            	<div class="col m6 s12 ">
                    ...
                    <img src="static/images/logo.jpeg" width="500px" >
                	 <form class="col s12" action="/gdgmcq/LoginController.html" method="post">
				                        ...
				                        <select class="browser-default  grey lighten-5" name="Gender">
